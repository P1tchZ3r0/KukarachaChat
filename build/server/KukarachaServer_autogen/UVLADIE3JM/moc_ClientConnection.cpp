...
#include "../../../../server/src/ClientConnection.h"
...
template <> constexpr inline auto ClientConnection::qt_create_metaobjectdata<qt_meta_tag_ZN16ClientConnectionE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(ClientConnection *)>(5, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 6, 7 },
        }}),
...
void ClientConnection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->connectionClosed((*reinterpret_cast<std::add_pointer_t<ClientConnection*>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ClientConnection::*)(const ChatMessage & )>(_a, &ClientConnection::messageReceived, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (ClientConnection::*)(ClientConnection * )>(_a, &ClientConnection::connectionClosed, 1))
            return;
    }
}
...
// SIGNAL 0
void ClientConnection::messageReceived(const ChatMessage & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void ClientConnection::connectionClosed(ClientConnection * _t1)
{
